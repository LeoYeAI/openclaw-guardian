---
name: lenny-wisdom
description: "Ask questions and get insights from Lenny's Podcast and Newsletter archive. Use when the user wants product, growth, GTM, pricing, AI product, or leadership advice grounded in real conversations with top founders and PMs. Triggers on @lenny, 'lenny says', 'lenny podcast', 'what does lenny think', 'Lenny archive', or whenever the user asks a product/growth/startup strategy question and wants insights from real practitioner experience. Also use when the user asks to setup lenny or initialize lenny-wisdom."
---

# lenny-wisdom

Retrieval-augmented Q&A over Lenny Rachitsky's Podcast and Newsletter archive.
...
- **Pricing/Monetization**: Madhavan Ramanujam, Andrew Wilkinson
